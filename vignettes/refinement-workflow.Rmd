...
decrease monotonically. Convex, concave and combined shape constraints are
...
available as advanced options. They should be used only when the assumed shape
has an actuarial or economic basis.
