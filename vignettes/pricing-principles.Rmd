...
This vignette outlines the key concepts that underpin pricing workflows in `insurancerating`.
...
Before fitting models, it is essential to understand the data. `factor_analysis()` provides a structured way to analyse:
