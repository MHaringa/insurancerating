...
In the allocation output, `expected_excess_loss` is the absolute monetary
burden assigned to a row. `blended_excess_loading` is the corresponding loading
per unit of the chosen weight, such as earned exposure. This distinction matters
