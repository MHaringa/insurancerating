...
The allocation step is where pooling and uncertainty are handled. Portfolio
pooling is stable but ignores group experience. Group pooling is responsive but
can be volatile. Partial pooling balances portfolio stability, group
