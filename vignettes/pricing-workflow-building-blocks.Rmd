...
burden assigned to a row. `allocated_excess_loading` is the corresponding
loading per unit of the chosen weight, such as earned exposure. This distinction
matters when the output is added back to pricing data.
