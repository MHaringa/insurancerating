...
lazy query and does not copy the source portfolio into R. Each output
row is a model point: one observed covariate combination together with
aggregated exposure and other additive quantities requested by the user.
