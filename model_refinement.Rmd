...
Na het bewerken van de data, het schatten van een GLM en het bepalen van risicopremies is de laatste stap in het proces het verfijnen van de risicopremie. Deze laatste stap is vaak onderbelicht. Dit document beschrijft voor deze verfijning twee veelvuldig toepasbare methoden. Ten eerste worden restricties op de risico factoren toegepast. Vaak wordt op basis van commerciële overwegingen een BM-ladder toegepast. Dit betekent dat de premieverhouding tussen de verschillende tredes in de BM-ladder niet wordt bepaald op basis van de historie in de portefeuille maar op basis van commerciële motieven. Ten tweede wordt vaak een *smoothing* op de geschatte premiefactoren toegepast. Dit betekent dat de overgang tussen de verschillende premieklassen geleidelijker verloopt. Dit document beschrijft beide methodieken en geeft daarbij voorbeelden. De eerste sectie beschrijft de portefeuille, vervolgens wordt een risicomodel geschat en daarna de risicopremies verfijnt. De theoretische onderbouwing van de methodes voor het verfijnen van het risicomodel is terug te vinden in de Appendix.  
...
Het is ook mogelijk om de graad van de polynoom aan te passen. Op basis van *expert judgement* kan hiermee een gewenste *smoothing* worden gedaan. Onderstaand voorbeeld geeft een eerste graads polynoom. 
...
Toon de nieuwe formule. Hierin is de risico factor met restricties opgenomen in de offset-term. Een offset is een fixed vector die wordt opgeteld bij de linear predictor van een model. Zie de Appendix voor meer achtergrond. 
...
Door bepaalde coefficienten vast te zetten zullen ook de andere coefficienten in het model aangepast worden. Toon de verschillen in coefficienten. Het valt op dat de coefficienten van de andere variabelen in dit geval slechts fractioneel aangepast worden door het vastzetten van de regiofactor zip. Wanneer de vastgezette coefficienten sterker zullen afwijken van de geschatte coefficienten zullen de verschillen in de andere coefficienten ook groter worden. 
